...
const NavBar = () => {
  ...
  const navLinks = [
    ...
    { href: "#testimals", label: "Testimals" },
  ];
  return (
    <nav className="fixed top-0 left-0 right-0 bg-white/90 backdrop-blur-sm z-50 border-b border-gray-100 shadow-sm">
      <div className="w-full container mx-auto flex items-center justify-between px-4 sm:px-6 lg:px-8 md:h-20 h-16">
        ...
        <div className="flex items-center gap-1 curser-pointer">
          <div className="h-4 w-4 bg-blue-500 rounded-full opacity-75 hover:opacity-100 transition-opacity"></div>
        ...
        <div className="hidden md:flex items-center gap-10">
          {navLinks.map((link, index) => (
            <a
              ...
              className={`text-sm font-medium relative after:absolute after:bottom-0 after:left-0 after:h-0.5 after:w-0 hover:hover:after:w-full after:bg-blue-600 after:transition-all ${
